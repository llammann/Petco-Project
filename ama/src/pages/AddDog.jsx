...
import { postPet } from './../redux/slices/AdminSlice';
...
const RegisterSchema = Yup.object().shape({
  ...
  img: Yup.string().min(2, 'Too Short!').max(35, 'Too Long!').required('Required'),
        ...
        <div className="myForm">
          ...
          <Formik
            ...
            onSubmit={(values, { resetForm }) => {
              dispatch(postPet(values));
              console.log("addValues",values)
              navigate('/dogs');
              resetForm();
              swal('Dog added successfully!', { icon: 'success' });
            }}
          >
            {({ errors, touched }) => (
              <Form>
